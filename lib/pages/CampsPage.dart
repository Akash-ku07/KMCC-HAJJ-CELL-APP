...
class CampsPage extends StatefulWidget {
  ...
  const CampsPage({super.key, required this.country});
...
class _CampsPageState extends State<CampsPage> {
  ...
  Future<void> openBox() async {
    ...
    setState(() {
      filteredCampsData = dataBox!.values
          .where((data) => data.Country.contains(widget.country))
          .toList();
    });
  }
  ...
  Future<void> loadExcelData() async {
    final ByteData data =
        await rootBundle.load('assets/excel/mina2023_cordinates_final.xlsx');
