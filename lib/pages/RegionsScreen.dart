...
class _RegionsPageState extends State<RegionsPage> {
  ...
  Future<void> openBox() async {
    ...
    regionsBox = await Hive.openBox<CountryModel>('regionBox');
  ...
  Future<void> loadExcelData() async {
    final ByteData data =
        await rootBundle.load('assets/excel/CountriesListFinal.xlsx');
    ...
    for (var table in excel.tables.keys) {
      ...
      for (var row in sheet.rows.skip(1)) {
        tempList.add(CountryModel(
          ...
          Arabic: row[2]?.value?.toString() ?? '',
          Image: row[3]?.value?.toString() ?? '',
        ));
        print(
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          print("country/${region.Country.trim().toLowerCase()}.png");
          ...
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CampsPage(country: region.Country)),
              );
            },
            child: Container(
              width: 120,
              ...
              child: Column(
                ...
                children: [
                  Container(
                      ...
                      child: ClipOval(
                        child: Image.asset(
                          'assets/images/country/${regions[index].Country.trim().toLowerCase()}.png',
                          width: 55,
                          height: 55,
                          fit: BoxFit.cover,
                          errorBuilder: (BuildContext context, Object exception,
                            ...
                            return Image.asset(
                              'assets/images/country/error.png',
                              width: 55,
                              height: 55,
                              fit: BoxFit.cover,
                            );
